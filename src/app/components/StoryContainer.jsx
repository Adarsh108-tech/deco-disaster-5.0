...
import curator_img from "../../../public/assets/curator.png";
import start_btn from "../../../public/assets/start_btn.svg";
...
const StoryContainer = () => {
  ...
  const REDIRECT_URL = "/round/1/stage/1"
      ...
      {isFirstClick && !storyFinished && (
        <>
          ...
          <div className=" w-[75%] px-5 sm:w-[80%] md:w-[65%] lg:w-[65%] h-[80%] sm:h-[50%] md:h-[60%] lg:h-[70%] flex justify-center items-center ">
            <div
              className={`h-full w-full flex flex-col items-center justify-center py-2`}
            >
              {storyChunks.map((chunk, index) => (
                <div className={gameStarted ? "grow-and-slide-top" : ""}>
                  <div
                    key={index}
